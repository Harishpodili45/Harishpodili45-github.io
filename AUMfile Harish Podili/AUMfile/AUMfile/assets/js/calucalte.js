$(document).ready(function(){
    ...
    $("#entries_submit").click(function(){
        ...
        let form="<div class='registration-page'><table class='table'>";
        for(let i=0;i<entries;i++)
        {
            form=form+"<tr><td >Letter Grade<td></td><td> \
                        ...
                        <tr><td >Credit Hours<td></td><td><input id='credit_hours"+i+"' style='width:88%' type='number' min=1 value=1 class='form-control'></td></tr>";
        }
        form =form+"</table></div>";
